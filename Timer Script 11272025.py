...
try:
    # =============================================================================
    # UTILITY FUNCTIONS - Defined inside try block for proper scope
    # =============================================================================
    ...
    def check_thingpark_inbound():
        ...
        try:
            ...
            start = system.date.now()
            browse_results = system.tag.browse(devices_root, {"recursive": True, "tagType": "AtomicTag"})
    ...
    # Handle case where system is not available at module initialization
    pass